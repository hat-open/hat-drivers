...
from hat.drivers.iec60870.app.iec104 import common


iec101_asdu_types = {common.M_SP_NA.value,
                     common.M_DP_NA.value,
                     common.M_ST_NA.value,
                     common.M_BO_NA.value,
                     common.M_ME_NA.value,
                     common.M_ME_NB.value,
                     common.M_ME_NC.value,
                     common.M_IT_NA.value,
                     common.M_PS_NA.value,
                     common.M_ME_ND.value,
                     common.M_SP_TB.value,
                     common.M_DP_TB.value,
                     common.M_ST_TB.value,
                     common.M_BO_TB.value,
                     common.M_ME_TD.value,
                     common.M_ME_TE.value,
                     common.M_ME_TF.value,
                     common.M_IT_TB.value,
                     common.M_EP_TD.value,
                     common.M_EP_TE.value,
                     common.M_EP_TF.value,
                     common.C_SC_NA.value,
                     common.C_DC_NA.value,
                     common.C_RC_NA.value,
                     common.C_SE_NA.value,
                     common.C_SE_NB.value,
                     common.C_SE_NC.value,
                     common.C_BO_NA.value,
                     common.M_EI_NA.value,
                     common.C_IC_NA.value,
                     common.C_CI_NA.value,
                     common.C_RD_NA.value,
                     common.C_CS_NA.value,
                     common.C_RP_NA.value,
                     common.P_ME_NA.value,
                     common.P_ME_NB.value,
                     common.P_ME_NC.value,
                     common.P_AC_NA.value,
                     common.F_FR_NA.value,
                     common.F_SR_NA.value,
                     common.F_SC_NA.value,
                     common.F_LS_NA.value,
                     common.F_AF_NA.value,
                     common.F_SG_NA.value,
                     common.F_DR_TA.value}
...
_asdu_type_time_sizes = {
    k: v for k, v in iec101.encoder.asdu_type_time_sizes
