...
static PyObject *get_peer_cert(PyObject *self, PyObject *args) {
    ...
    if (!cert) {
        PyErr_SetString(PyExc_Exception, "peer certificate not available");
        return NULL;
    }
...
static PyObject *is_pub_key_ec(PyObject *self, PyObject *args) {
    PyObject *key_obj;
    if (!PyArg_ParseTuple(args, "O", &key_obj))
        return NULL;
    ...
    int result = EVP_PKEY_base_id(key) == EVP_PKEY_EC;
    return PyBool_FromLong(result);
}
...
PyMethodDef methods[] = {{.ml_name = "key_update",
                         ...
                         {.ml_name = "is_pub_key_rsa",
                          ...
                          .ml_flags = METH_VARARGS},
                         {.ml_name = "is_pub_key_ec",
                          .ml_meth = (PyCFunction)is_pub_key_ec,
                          .ml_flags = METH_VARARGS},
